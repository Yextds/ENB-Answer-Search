...
answersHeadlessConfig.verticalKey = "enb_news";
const searcher = provideHeadless(answersHeadlessConfig);

const EnbNewsPage: Template<TemplateRenderProps> = ({
  relativePrefixToRoot,
  path,
  document,
}) => {
      ...
      <SearchHeadlessProvider searcher={searcher}>
        <div className="px-4 py-8">
          <div className="mx-auto flex max-w-5xl flex-col">
            ...
            <VerticalResults displayAllOnNoResults={true} CardComponent={EnbCards} />
            {/* <LocationBias /> */}
          </div>
          <NewPagination/>
        </div>
