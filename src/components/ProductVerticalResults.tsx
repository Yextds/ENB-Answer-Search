...
/**
 * This function render the results on the Vertical Page
 * @param props Card - Made for that vertical
 * @returns Results on the Vertical
 */
export default function ProductVerticalResults(
...
const builtInPaginationCssClasses: PaginationCssClasses = {
  ...
  labelContainer: "inline-flex shadow-sm -space-x-px one",
  label:
  ...
  return (
    <div className={cssClasses.container}>
      <nav className={cssClasses.labelContainer} aria-label="Pagination">
        ...
        >
          <PageNavigationIcon
            className={cssClasses.icon + " transform -rotate-90"}
          />
        </button>
