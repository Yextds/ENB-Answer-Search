 ...
 */
export function EventCard(props: StandardCardProps): JSX.Element {
  ...
  */
  ...
  const eventName =  Links.name;
  const eventDesc = Links.c_description;
  const eventDate = Links.c_date;
      ...
      <div className={cssClasses.container}>
        <div>
          {/* <a href={LinkLandingPage}> */}
            <h3 className={cssClasses.header}>{eventName}</h3>
          {/* </a> */}
          <p>{eventDate}</p>
          <p>{eventDesc}</p>
        </div>
