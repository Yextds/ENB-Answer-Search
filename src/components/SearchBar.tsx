...
export const builtInCssClasses: SearchBarCssClasses = {
  ...
  inputDropdownContainer:
    "bg-white border rounded-3xl border-gray-200 w-full overflow-hidden",
  ...
  searchButtonContainer:
    " w-8 h-full mx-2 flex flex-col justify-center items-center",
...
export default function SearchBar({
  ...
  const [executeQuery, autocompletePromiseRef] = useSearchWithNearMeHandling(
    answersActions,
    geolocationOptions
  );
